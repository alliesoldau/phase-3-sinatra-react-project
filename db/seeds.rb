...
puts  "🏠 Seeding mytank data..."

brackish_tank = Mytank.create(tank_name: "Brackish Tank", environment_id: brackish.id)
salt_tank = Mytank.create(tank_name: "Salt Tank", environment_id: salt.id)
fresh_tank = Mytank.create(tank_name: "Fresh Tank", environment_id: fresh.id)
...
ballon_molly = Critter.create(critter_name: "Ballon Molly", critter_type: "fish", food_id: flakes.id, environment_id: brackish.id, mytank_id: brackish_tank.id)
black_fin_shark = Critter.create(critter_name: "Black Fin Shark", critter_type: "shark", food_id: shrimp.id, environment_id: brackish.id, mytank_id: brackish_tank.id)
...
snail = Critter.create(critter_name: "Snail", critter_type: "shelled", food_id: algae.id, environment_id: salt.id, mytank_id: salt_tank.id)
hermit_crab = Critter.create(critter_name: "Hermit Crab", critter_type: "shelled", food_id: algae.id, environment_id: salt.id, mytank_id: salt_tank.id)
...
frog = Critter.create(critter_name: "Frog", critter_type: "frog", food_id: worms.id, environment_id: fresh.id, mytank_id: fresh_tank.id)
plecko = Critter.create(critter_name: "Plecko", critter_type: "fish", food_id: algae.id, environment_id: fresh.id, mytank_id: fresh_tank.id)
